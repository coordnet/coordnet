#!/bin/sh
# Copied from https://github.com/edoburu/docker-pgbouncer/blob/4afb4a755969647d15eb89c3bc8a4dc2e46322b1/entrypoint.sh
# See Dockerfile for additional notes. Original source:
