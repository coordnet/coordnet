...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-violet-700
      data-[state=unchecked]:bg-slate-200 dark:focus-visible:ring-slate-300
      dark:focus-visible:ring-offset-slate-950 dark:data-[state=checked]:bg-slate-50
