...
>(({ className, inset, children, ...props }, ref) => (
  <ContextMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      focus:bg-slate-100 focus:text-slate-900 data-[state=open]:bg-slate-100
      data-[state=open]:text-slate-900 dark:focus:bg-slate-800 dark:focus:text-slate-50
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      data-[side=top]:slide-in-from-bottom-2 dark:border-slate-800 dark:bg-slate-950
      dark:text-slate-50`,
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ...
      className={cn(
        `z-50 min-w-[8rem] overflow-hidden rounded-md border border-slate-200 bg-white p-1
        text-slate-950 shadow-md animate-in fade-in-80 data-[state=open]:animate-in
