...
const NodeRepository = ({ className }: NodeProps) => {
  ...
  return visible && !isQuickViewOpen ? (
    ...
    >
      <div
        className="pointer-events-auto mt-16 w-full max-w-[600px] rounded-md border
      ...
      >
        ...
        <ul
          ref={nodeListRef}
          className={clsx(
            "-webkit-overflow-scrolling-touch max-h-[50vh] overflow-y-auto px-2 py-1.5",
            {
        ...
        >
          ...
          {results.map((item, index) => (
            <li
              className={clsx(
                "flex flex-wrap items-start rounded px-2 py-1.5 text-sm",
            ...
            >
              <div className="flex w-full flex-col">
                ...
                <div className="flex flex-wrap gap-1 text-xs font-medium text-neutral-400">
                  {!spacesLoading && (
                    <>
