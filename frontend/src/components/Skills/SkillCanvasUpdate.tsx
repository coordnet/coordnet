...
import { BackendEntityType, SkillUpdateForm, SkillUpdateFormSchema } from "@/types";
...
import { skillYdocToJson } from "./utils";
...
const SkillCanvasUpdate = ({
  ...
  const onSubmit = async (data: SkillUpdateForm) => {
    ...
    try {
      ...
      await createSkillVersion(parent.id, canvasData);
