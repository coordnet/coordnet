...
const Menubar = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof MenubarPrimitive.Root> & { unstyled?: boolean }
...
const MenubarTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof MenubarPrimitive.Trigger> & { unstyled?: boolean }
>(({ className, unstyled = false, ...props }, ref) => (
