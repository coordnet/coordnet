...
import MethodCardExpanded from "@/components/Methods/MethodCardExpanded";
                    ...
                    .map((card, i) => (
                      <Dialog key={`profile-card-${card.id}-${i}`}>
                        <DialogTrigger className="text-left">
                          <MethodCard className="cursor-pointer" card={card} />
                        </DialogTrigger>
                        {profile && <MethodCardExpanded profile={profile} card={card} />}
                      </Dialog>
                    ))}
