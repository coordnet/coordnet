...
const Method = ({ isMethodRun }: { isMethodRun: boolean }) => {
...
const MethodOuter = () => {
  ...
  return (
    <NodesContextProvider methodId={methodId} isMethodRun={Boolean(runId)}>
      <Method isMethodRun={Boolean(runId)} />
